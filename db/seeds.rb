...
rogan = Person.create(name: "Joe Rogan", birthday: "1967-8-11", deathday: Date.today.to_s , city: smijan )
tesla = Person.create(name: "Nikola Tesla", birthday: "7/10/1856", deathday: "1/7/1943", city: newark )
bean = Person.create(name: "Ben Lim", birthday: "20/4/1996", deathday: Date.today.to_s , city: swampland)

nt_timeline = Timeline.create(title: "Life of Nikola Tesla", user: wesley, person: tesla, picture: "https://i.imgur.com/S3b0qFS.jpeg/")
jr_timeline = Timeline.create(title: "Life of Rogan", user: john, person: rogan, picture: "https://i.imgur.com/XqClye6.jpg")
